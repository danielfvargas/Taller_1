...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("****************************************");
        System.out.println("*       MENÚ JUEGOS OLÍMPICOS          *");
        System.out.println("****************************************");
		...
		System.out.println("13. Consultar el país de un atleta dado su nombre");
	...
	/**
	 * Ejecuta la opción para consultar el país de un atleta.
	 */
